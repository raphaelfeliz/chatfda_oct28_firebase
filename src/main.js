...
document.addEventListener('DOMContentLoaded', () => {
    ...
    try { // Add a try...catch around initialization for safety
        ...
        // This MUST match the CSS filename currently LIVE on Firebase Hosting
        styleLink.href = 'https://gen-lang-client-0545699517.web.app/assets/index-DPyQX36T.css'; // <-- THE ONLY CHANGE NEEDED
        // --- DEBUG LOG & BUILD REMINDER ---
        console.warn(`[Widget] Loading CSS: ${styleLink.href}. ` +
